...
contract IPXTest is Test, IERC721Receiver {
    ...
    function test_getListRentFromMyIp_PreventsDuplicates() public {
        ...
        uint256 tokenId1 = ipX.registerIP("IP One", "First IP for rent", 1, "ipfs://file1", 0, 0 ether, 1 ether, 5);
        uint256 tokenId2 = ipX.registerIP("IP Two", "Second IP for rent", 2, "ipfs://file2", 0, 0 ether, 2 ether, 7);
    ...
    function test_getListRentFromMyIp_General_Part2() public {
        ...
        ipX.registerIP("Other IP", "Other owner's IP", 4, "ipfs://other", 0, 1 ether, 0, 5);
    ...
    function test_getListRentFromMyIp_General_Part3() public {
        ...
        IPX.RentedIP[] memory rents = ipX.getListRent(renter1);
